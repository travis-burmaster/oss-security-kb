...
|-------------|----------|-------------|----------|--------|
| CVE-2024-43799 | Medium | XSS in 404/403 error HTML response | 0.19.1 | [GHSA](https://github.com/advisories/GHSA-m6fv-jmcg-4jfg) |
...
- Path traversal defenses are comprehensive and well-layered. The 4-layer defense (decode, null check, normalize, regex) is a model implementation.
...
---
*Last updated: 2026-04-13 | Sources: 5 (upstream repository, source code audit of send 1.1.0 via Express audit, GHSA database, npm registry, Express threat model)*
