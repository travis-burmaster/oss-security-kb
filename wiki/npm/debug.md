...
|-------------|----------|-------------|----------|--------|
| GHSA-4x49-vf9v-38px / CVE-2025-59144 | High | `debug@4.4.2` was published with malicious code after an npm account takeover; advisory text says the payload attempted browser-targeted cryptocurrency-transaction redirection, and recommends cache purges and full bundle rebuilds. OSV tracks this incident with aliases including `MAL-2025-46974` and `GHSA-8mgj-vmr8-frr6` (same incident, not separate vulnerabilities). | 4.4.3 | [GitHub Advisory Database](https://github.com/advisories/GHSA-4x49-vf9v-38px); [OSV GHSA-4x49-vf9v-38px](https://osv.dev/vulnerability/GHSA-4x49-vf9v-38px); [OSV MAL-2025-46974](https://osv.dev/vulnerability/MAL-2025-46974) |
...
---
*Last updated: 2026-05-04 | Sources: 8 (GitHub Advisory Database, OSV.dev package query + OSV vulnerability records for GHSA-4x49-vf9v-38px and MAL-2025-46974, NVD CVE record, upstream issue thread, GitHub security-policy page, npm registry metadata, npm downloads API)*
