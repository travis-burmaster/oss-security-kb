...
| CVE-2015-2296 / GHSA-pg2w-x9wp-vw92 | TBD | OSV lists a Requests session-fixation issue (CVE-2015-2296). | 2.6.0 | https://osv.dev/vulnerability/GHSA-pg2w-x9wp-vw92 |
| CVE-2014-1830 / GHSA-652x-xj99-gmcc | TBD | OSV lists an exposure-of-sensitive-information issue (CVE-2014-1830) fixed in Requests 2.3.0. | 2.3.0 | https://osv.dev/vulnerability/GHSA-652x-xj99-gmcc |
| CVE-2014-1829 / GHSA-cfj3-7x9c-4p3h | TBD | OSV lists an exposure-of-sensitive-information issue (CVE-2014-1829) fixed in Requests 2.3.0. | 2.3.0 | https://osv.dev/vulnerability/GHSA-cfj3-7x9c-4p3h |
...
---
*Last updated: 2026-04-28 | Sources: 10 (OSV package query + per-vuln OSV pages for GHSA-gc5v-m9x4-r6x2, GHSA-cfj3-7x9c-4p3h, GHSA-652x-xj99-gmcc, GHSA-pg2w-x9wp-vw92; GHSA advisory pages for recent fixes; upstream Requests release notes; NVD CVE record for CVE-2018-18074)*
