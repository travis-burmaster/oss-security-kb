...
| CVE-2018-18074 / GHSA-x84v-xcm2-53pg | High | Requests before 2.20.0 sends an HTTP `Authorization` header to an `http` URI upon receiving a same-hostname HTTPS→HTTP redirect, which can expose credentials to passive network observers. | 2.20.0 | https://osv.dev/vulnerability/PYSEC-2018-28 (OSV) · https://github.com/advisories/GHSA-x84v-xcm2-53pg (GHSA) |
...
---
*Last updated: 2026-05-02 | Sources: 10 (OSV package query + GitHub Advisory Database JSON for GHSA-pg2w-x9wp-vw92, GHSA-652x-xj99-gmcc, GHSA-cfj3-7x9c-4p3h + OSV/GHSA for GHSA-gc5v-m9x4-r6x2; GHSA advisory pages for recent fixes; upstream Requests release notes; OSV PYSEC-2018-28 + GHSA-x84v-xcm2-53pg for CVE-2018-18074)*
